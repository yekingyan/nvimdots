...
local plug_map = {
	-- Plugin: vim-fugitive
	["n|gp"] = map_cr("G push"):with_noremap():with_desc("git: Push"),
	["n|gl"] = map_cr("G pull"):with_noremap():with_desc("git: Pull"),
	["n|glb"] = map_cr("G pull"):with_noremap():with_desc("git: Pull --rebase"),
